...
from utils.convex_adam_utils import *
import time
import argparse
import einops
import warnings
from utils import losses, misc, metrics
import pytz
...
def convex_adam_3d_param(feature_fixed,
    ...
    if lambda_weight > 0:
        ...
        seg_fixed = F.max_pool3d(seg_fixed, kernel_size=grid_sp_adam, stride=grid_sp_adam).cuda()
        ...
        for iter in range(selected_niter):
            ...
            seg_warped = F.grid_sample(seg_moving.float(),
                                              grid_disp.view(1, H // grid_sp_adam, W // grid_sp_adam, D // grid_sp_adam,
                                                             3).cuda(), align_corners=False, mode='nearest')
